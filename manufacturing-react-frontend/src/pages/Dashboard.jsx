...
const profileSidebarStyles = {
  sidebar: { position: "absolute", right: 0, top: 50, width: 200, background: "#fff", border: "1px solid #eaeaea", borderRadius: 8, padding: 12, zIndex: 1600, boxShadow: "0 4px 16px rgba(0,0,0,0.08)" },
  closeBtn: { position: "absolute", top: 4, right: 6, background: "none", border: "none", fontSize: 18, cursor: "pointer" },
  list: { listStyle: "none", padding: 0, margin: 0 },
  item: { padding: "10px 6px", cursor: "pointer", borderRadius: 4, transition: "background 0.15s", marginBottom: 4, background: "#f7f8fa" },
};
